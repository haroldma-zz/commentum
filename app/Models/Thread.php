...
class Thread extends Model
{
    ...
    public function calculateMomentum()
    {
        ...
        $this->momentum = DB::SELECT(DB::RAW("SELECT calculateThreadMomentum(impressions, views, total_momentum) as momentum FROM (SELECT t.*, COALESCE(sum(c.momentum), 0) as total_momentum
        FROM threads t
